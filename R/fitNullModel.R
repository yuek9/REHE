...
setMethod("fitNullModelREHE",
          ...
          function(x, outcome,
                   ...
                   EM.iter = 0,
                   drop.zeros = TRUE,
                   verbose = TRUE, computeCI=F, subsample=F, ratio=0.05, nsub = 50, option='mean') {
              ...
              .fitNullModelREHE(y=desmat$y, X=desmat$X, covMatList=cov.mat,
                            ...
                            drop.zeros=drop.zeros, verbose=verbose, computeCI=computeCI, subsample=subsample, ratio=ratio, nsub = nsub, option=option)
          })
