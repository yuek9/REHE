...
input = read.table(paste0('input_simulation_reREHE.txt'), header=T)
...
save.image(paste0("dense_reREHE_only_",paste(argv, collapse='_'),'_ratio_', ratio, "_condition_", condition, ".RData"))
